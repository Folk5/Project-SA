$(document).ready(function () {
    ...
    var activeRow = null;
    let valueBruteforce = 0;
    let isBruteforce = false;
    const inputBruteforce = document.getElementById("maxBerat");
    const resetBruteforce = document.getElementById("resetBruteforce");
    ...
    inputBruteforce.addEventListener("input", function () {
        valueBruteforce = this.value;
    });

    resetBruteforce.addEventListener("click", function () {
        isBruteforce = false;
        valueBruteforce = 0;
        inputBruteforce.value = 0;
        customers = JSON.parse(localStorage.getItem('customers'));
        renderTable(customers);
    });

    formBruteforce.addEventListener("submit", function (event) {
    ...
    function filterBruteforce(customers) {
        ...
        for (const subset of allSubsets) {
            ...
            if (totalBerat <= valueBruteforce && totalProfitSubset > maxProfit) {
