$(document).ready(function () {
    ...
    formGreedy.addEventListener("submit", function (event) {
        ...
        isGreedy = true
        const filter = filterGreedy(JSON.parse(localStorage.getItem('customers'))).map(cust => ({
            ...cust,
            isDone: true
        }));
    ...
    function filterGreedy(customers) {
        // Fungsi untuk menghitung total profit dari seorang customer
        ...
        customers.sort(function (a, b) {
            return totalProfit(b) - totalProfit(a);
        });
        ...
        for (let customer of customers) {
            let berat = totalWeight(customer);
            if (totalBerat + berat <= valueGreedy) {
                totalBerat += berat;
    ...
    // Fungsi untuk menghitung total profit dan mengurutkan pelanggan berdasarkan profit
    function calculateAndSortCustomers(customers) {
        ...
        // Sortir pelanggan berdasarkan totalProfit dalam urutan menurun
        customers.sort(function (a, b) {
    ...
    function renderTable(customers) {
        ...
        $.each(customers, function (index, customer) {
            ...
            // Menghitung total kuantitas, berat, waktu, dan profit dari setiap pelanggan
            ...
            // Menambahkan informasi pelanggan ke dalam baris tabel
            ...
            row.click(function () {
                ...
                if (clickedRow.next().hasClass('customer-details')) {
                    ...
                    // Menampilkan detail pelanggan ketika baris tabel diklik
            ...
            // Menambahkan tombol hapus dan selesai ke dalam baris tabel
            row.find('.delete-btn').click(function () {
                // Algoritma Greedy: Ketika tombol hapus ditekan, data pelanggan dihapus dari localStorage tanpa pertimbangan lain.
                Swal.fire({
                    title: 'Are you sure?',
            ...
            // Tombol selesai hanya memberikan pemberitahuan kepada pengguna
            ...
            // Menambahkan baris tabel ke dalam tabel pelanggan
            tbody.append(row);
        });
    }
});
